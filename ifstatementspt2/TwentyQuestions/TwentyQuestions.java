//if statements part 2 Twenty questions 35 pts Angel Chuang
...
public class TwentyQuestions
{
    public static void main (String[] args)
    {
        ...
        if( answer1.equals("no"))
        {
            if( answer.equals("animal"))
            {
                System.out.println("My guess is that you are thnking of a squirrel.");
            }
            else if( answer.equals("vegetable"))
            {
        ...
        System.out.println("I would ask you if I'm right, but I don't actually cares.");
